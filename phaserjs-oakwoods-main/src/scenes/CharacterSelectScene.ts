...
import { CHAR_SELECT_SCALE } from '../utils/charSprite';
...
export class CharacterSelectScene extends Phaser.Scene {
  ...
  private buildGenderSelect(): void {
    ...
    this.maleSprite = this.add.sprite(W / 2 - 90, 200, 'char-player-m', 0)
      .setScale(CHAR_SELECT_SCALE).setDepth(3);
    ...
    this.femaleSprite = this.add.sprite(W / 2 + 90, 200, 'char-player-f', 0)
      .setScale(CHAR_SELECT_SCALE).setDepth(3);
